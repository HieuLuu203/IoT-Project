...
const countWarning = require('../controllers/countWarning.controller');
/**
 * @swagger
 * tags:
 *   - name: Fan
 ...
 */
router.post('/api/v1/change-fan', changeFan);
/**
 * @swagger
 * /api/v1/change-air:
 *   post:
...
router.post('/api/v1/change-air', changeAir);
/**
 * @swagger
 * /api/v1/change-lamp:
 *   post:
 ...
 */
router.post('/api/v1/change-lamp', changeLamp);

/**
 * @swagger
 * /api/v1/top-10-sensor:
 *   get:
 *     tags:
 *       - Sensor
 ...
 */
router.get('/api/v1/top-10-sensor', topLastSensor.topLastSensor);
 ...
 *         description: Internal server error
 */
router.get('/api/v1/all-sensors', getAllSenSor);


router.get('/api/v1/count-warning', countWarning);
